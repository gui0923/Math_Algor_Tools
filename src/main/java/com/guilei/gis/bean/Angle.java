...
public class Angle implements Comparable<Angle>
{
    ...
    public final static Angle POS45 = Angle.fromDegrees(45);
    ...
    public final static Angle POS50 = Angle.fromDegrees(50);
    public final static Angle POS75 = Angle.fromDegrees(75);
    public final static Angle NEG75 = Angle.fromDegrees(-75);

    private final static double DEGREES_TO_RADIANS = Math.PI / 180d;
    final static double RADIANS_TO_DEGREES = 180d / Math.PI;
    ...
    {
        return new Angle().fromDegreesLocal(degrees);
    }

    public Angle fromDegreesLocal(double degrees)
    {
        setDegrees(degrees);
        return this;
    }
    ...
    {
        return this.radians;// degrees, DEGREES_TO_RADIANS * degrees
    }

    public final Angle setDegrees(double degrees)
    {
        this.degrees = degrees;
    ...
    public final Angle setRadians(double radians)
    {
        this.radians = radians;
        this.degrees = radians / DEGREES_TO_RADIANS;
        return this;
    }

    public final Angle add(Angle angle)
    {
        return add(angle, null);
    }
     ...
     */
    public final Angle add(Angle angle, Angle store)
    {
        if (angle == null)
        {
            return this;
        ...
        return store.setDegrees(this.degrees + angle.degrees);
    }

    public final Angle addLocal(Angle angle)
    {
//        if (angle == null)
//        {
...
//        }
    ...
    public final Angle subtractLocal(Angle angle)
    {
//        if (angle == null)
//        {
//            String message = Logging.getMessage("nullValue.AngleIsNull");
...
//        }
    ...
    public final Angle multiply(double multiplier, Angle store)
    {
        if (store == null)
        {
            store = new Angle();
        }
        return store.fromDegreesLocal(this.degrees * multiplier);
    }

    public final Angle multiplyLocal(double multiplier)
    {
        setDegrees(this.degrees * multiplier);
        return this;
    }
...
//        }
    ...
    public final Angle addDegreesLocal(double degrees)
    {
    ...
    public final Angle subtractDegreesLocal(double degrees)
    {
        setDegrees(this.degrees - degrees);
        return this;
    }
     ...
     */
    public final Angle divide(double divisor, Angle store)
    {
        if (store == null)
        {
            store = new Angle();
        }
        return store.setDegrees(this.degrees / divisor);
    }
    ...
    public final Angle divideLocal(double divisor)
    {
        setDegrees(this.degrees / divisor);
        return this;
    }

    public final Angle addRadiansLocal(double radians)
    {
        setRadians(this.radians + radians);
        return this;
    }

    public final Angle subtractRadiansLocal(double radians)
    {
        setRadians(this.radians - radians);
        return this;
    }
...
//        }
    ...
    public Angle angularDistanceToLocal(Angle angle)
    {
//        if (angle == null)
//        {
//            String message = Logging.getMessage("nullValue.AngleIsNull");
...
//        }
    ...
    public Angle midAngleLocal(Angle a1, Angle a2)
    {
//        if (a1 == null || a2 == null)
//        {
//            String message = Logging.getMessage("nullValue.AngleIsNull");
...
//        }
        ...
        return setDegrees(0.5 * (a1.degrees + a2.degrees));
    }
...
//        }
    ...
    {
        return new Angle().averageLocal(a, b);
    }

    public Angle averageLocal(Angle a, Angle b)
    {
//        if (a == null || b == null)
//        {
//            String message = Logging.getMessage("nullValue.AngleIsNull");
...
//        }
        ...
        return setDegrees(0.5 * (a.degrees + b.degrees));
    }
...
//        }
        ...
        if (this.degrees < angle.degrees) return -1;
...
//        }
    ...
    public boolean equals(Object o)
    {
        ...
        if (angle.degrees != this.degrees) return false;
